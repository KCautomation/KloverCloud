...
class TestCreatePython(EnvironmentSetup):
    ...
    def test_dj_none_01(self):
        ...
        print("************************ Create Python Application based on Team: None **********************")
        ...
        try:
            ...
            if ApplicationName_box.is_enabled():
                ...
                ApplicationName_box.send_keys('test_dj_none_01')
                time.sleep(2)
            else:
        ...
        ss = SS(driver)
        file_name = ss_path + "test_dj_none_01_scrrenshot_" + time.asctime().replace(":", "_") + ".png"
        ss.driver.save_screenshot(file_name)
        ss.ScreenShot(file_name)

    def test_dj_none_02(self):
        # pytest.skip("Skipping test...later I will implement...")
        pageUrl = "https://eks.rakibefstestmaincluster782.klovercloud.io/"
        driver = self.driver
        ...
        try:
            ...
            if ApplicationName_box.is_enabled():
                print("ApplicationName_box is enable")
                ApplicationName_box.send_keys('test_dj_none_02')
                time.sleep(2)
            else:
                print("ApplicationName_box is not enable")
        except NoSuchElementException as e:
        ...
        #     print('Successfully clicked on Create_Application')
        ss = SS(driver)
        file_name = ss_path + "test_dj_none_02_scrrenshot_" + time.asctime().replace(":", "_") + ".png"
        ss.driver.save_screenshot(file_name)
        ss.ScreenShot(file_name)

    def test_dj_none_03(self):
        pytest.skip("Skipping test...later I will implement...")
        pageUrl = "https://eks.rakibefstestmaincluster782.klovercloud.io/"
        driver = self.driver
        ...
        try:
            ...
            if ApplicationName_box.is_enabled():
                print("ApplicationName_box is enable")
                ApplicationName_box.send_keys('test_dj_none_03')
                time.sleep(2)
            else:
                print("ApplicationName_box is not enable")
        except NoSuchElementException as e:
        ...
        #     print('Successfully clicked on Create_Application')
        ss = SS(driver)
        file_name = ss_path + "test_dj_none_03_scrrenshot_" + time.asctime().replace(":", "_") + ".png"
        ss.driver.save_screenshot(file_name)
        ss.ScreenShot(file_name)

    def test_dj_none_04(self):
        # pytest.skip("Skipping test...later I will implement...")
        pageUrl = "https://eks.rakibefstestmaincluster782.klovercloud.io/"
        driver = self.driver
        ...
        try:
            ...
            if ApplicationName_box.is_enabled():
                print("ApplicationName_box is enable")
                ApplicationName_box.send_keys('test_dj_none_04')
                time.sleep(2)
            else:
                print("ApplicationName_box is not enable")
        except NoSuchElementException as e:
        ...
        #     print('Successfully clicked on Create_Application')
        ss = SS(driver)
        file_name = ss_path + "test_dj_none_04_scrrenshot_" + time.asctime().replace(":", "_") + ".png"
        ss.driver.save_screenshot(file_name)
        ss.ScreenShot(file_name)

    def test_dj_none_05(self):
        # pytest.skip("Skipping test...later I will implement...")
        pageUrl = "https://eks.rakibefstestmaincluster782.klovercloud.io/"
        driver = self.driver
        ...
        #     print('Successfully clicked on Create_Application')
        ss = SS(driver)
        file_name = ss_path + "test_dj_none_05_scrrenshot_" + time.asctime().replace(":", "_") + ".png"
        ss.driver.save_screenshot(file_name)
        ss.ScreenShot(file_name)

    def test_dj_none_06(self):
        pytest.skip("Skipping test...later I will implement...")
        pageUrl = "https://eks.rakibefstestmaincluster782.klovercloud.io/"
        driver = self.driver
        ...
        try:
            ...
            if ApplicationName_box.is_enabled():
                print("ApplicationName_box is enable")
                ApplicationName_box.send_keys('test_dj_none_06')
                time.sleep(2)
            else:
                print("ApplicationName_box is not enable")
        except NoSuchElementException as e:
        ...
        #     print('Successfully clicked on Create_Application')
        ss = SS(driver)
        file_name = ss_path + "test_dj_none_06_scrrenshot_" + time.asctime().replace(":", "_") + ".png"
        ss.driver.save_screenshot(file_name)
        ss.ScreenShot(file_name)
