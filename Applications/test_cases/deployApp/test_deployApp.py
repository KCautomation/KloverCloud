...
class TestDeploy(EnvironmentSetup):
    ...
    def test_deploy(self):
        ...
        try:
            ...
            # if Deployed_status.is_displayed():
            #     print('Shown a message: ',
            #           simple_colors.green(Deployed_status.text, ['bold', 'underlined']))
            #     pass
            # else:
            #     print("Application Deployed failed")

            # Deployed_success_status = WebDriverWait(driver, 20).until(
            #     EC.presence_of_element_located((By.XPATH, Locator.Application_Deployed)))
            # if Deployed_success_status.is_displayed():
            #     print('Shown a message: ',
            #           simple_colors.green(Deployed_success_status.text, ['bold', 'underlined']))
            #     pass
            # else:
            #     print("Application Deployed failed")
